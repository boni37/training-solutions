...
public class BookArraySearchTest {
    ...
    public void setUp() throws IOException {
        InputStream is = BookArraySearch.class.getResourceAsStream("books.csv");
        String line;
    ...
    public void emptyParametersShouldThrowExceptionNull() throws IllegalArgumentException {
        ...
        Exception ex = assertThrows(IllegalArgumentException.class, () -> new BookArraySearch(bookList.toArray(bookArray)).findBookByAuthorTitle(null, null));
        assertEquals("Author or title must not be empty!", ex.getMessage());
