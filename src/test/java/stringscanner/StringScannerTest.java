...
public class StringScannerTest {
    ...
    @Test
    public void parameterIsNullShouldThrowException() throws NullPointerException {

        Exception ex = assertThrows(NullPointerException.class, () -> new StringScanner().readAndSumValues("3:2:4", null));
        assertEquals("Incorrect parameter string!", ex.getMessage());
